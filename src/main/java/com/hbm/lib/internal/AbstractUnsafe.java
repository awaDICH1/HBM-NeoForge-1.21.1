...
public abstract sealed class AbstractUnsafe permits SunUnsafeWrapper {
    ...
    public static AbstractUnsafe getUnsafe() {
        // 原 JPMS 分支 InternalUnsafeWrapper（jdk.internal.misc.Unsafe 绑定）未迁移；
        // SunUnsafeWrapper 通过 sun.misc.Unsafe.theUnsafe（NeoForge 已 --add-opens java.base/sun.misc）可用
