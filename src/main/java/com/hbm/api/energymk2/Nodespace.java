...
public class Nodespace {
    ...
    @Deprecated public static PowerNode getNode(Level world, BlockPos pos) {
        return (PowerNode) UniNodespace.getNode(world, pos, THE_POWER_PROVIDER);
    }

    @Deprecated public static void createNode(Level world, PowerNode node) {
        UniNodespace.createNode(world, node);
    }

    @Deprecated public static void destroyNode(Level world, BlockPos pos) {
