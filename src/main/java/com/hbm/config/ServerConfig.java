...
/**
 * 迁移自 1.12.2 com.hbm.config.ServerConfig（JSON 运行配置，hbmServer.json 位于 config/hbmConfig/）。
 * 逻辑原样保留；依赖的 RunningConfig 已迁移 ✓。
 * 引用点：HbmLivingCapability/HbmLivingProps（ENABLE_MKU）、HbmPotion.taint 分支（TAINT_TRAILS）。
 */
