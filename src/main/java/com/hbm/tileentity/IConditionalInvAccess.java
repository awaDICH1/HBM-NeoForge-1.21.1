 ...
 * All logic from these methods should be moved into capability-aware overrides within the BlockEntity class itself.
 *
 * <p><b>Porting Guide:</b></p>
 * <ol>
 *   <li>Remove {@code implements IConditionalInvAccess} from your BlockEntity.</li>
 *   <li>In your BlockEntity, override the new methods from {@link TileEntityMachineBase}:
 *     <ul>
 *       <li>{@code getAccessibleSlotsFromSide(Direction side, BlockPos accessorPos)}</li>
 *       <li>{@code canInsertItem(int slot, ItemStack stack, Direction side, BlockPos accessorPos)}</li>
 *       <li>{@code canExtractItem(int slot, ItemStack stack, int amount, Direction side, BlockPos accessorPos)}</li>
 *     </ul>
 *   </li>
