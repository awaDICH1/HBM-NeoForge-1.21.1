...
public class FluidType {
    ...
    public FluidType(String name, int color, int p, int f, int r, EnumSymbol symbol) {
        ...
        this.reactivity = r;
        this.symbol = symbol;
        this.texture = ResourceLocation.parse(Tags.MODID + ":textures/gui/fluids/" + name.toLowerCase(Locale.US) + ".png");
    ...
    public FluidType setupCustom(String name, int color, int p, int f, int r, EnumSymbol symbol, String texName, int tint, int id, String displayName) {
        ...
        this.reactivity = r;
        this.symbol = symbol;
        this.texture = ResourceLocation.parse(Tags.MODID + ":textures/gui/fluids/" + texName + ".png");
        this.guiTint = tint;
    ...
    public Fluid getFF(){
        ...
        // 1.21.1 Registries.FLUID 是 ResourceKey；取具体注册表用 BuiltInRegistries.FLUID
        return BuiltInRegistries.FLUID.get(ResourceLocation.parse(this.getFFName()));
    }
     ...
     * @param tank
     */
    public void onTankBroken(BlockEntity te, FluidTankNTM tank) { }
    /**
     ...
     * @param tank
     */
    public void onTankUpdate(BlockEntity te, FluidTankNTM tank) { }
    /**
     ...
     */
    public void onFluidRelease(BlockEntity te, FluidTankNTM tank, int overflowAmount) {
        this.onFluidRelease(te.getLevel(), te.getBlockPos().getX(), te.getBlockPos().getY(), te.getBlockPos().getZ(), tank, overflowAmount);
    }

    public void onFluidRelease(Level world, int x, int y, int z, FluidTankNTM tank, int overflowAmount) { }
