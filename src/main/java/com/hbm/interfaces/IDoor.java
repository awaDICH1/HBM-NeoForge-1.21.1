...
/**
 * 迁移自 1.12.2 com.hbm.interfaces.IDoor。
 * 变更：BlockEntity → BlockEntity；
 * getBlockType().getRegistryName().toString() → BuiltInRegistries.BLOCK.getKey(getBlockState().getBlock()).toString()；
